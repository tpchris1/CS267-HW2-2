...
void simulate_one_step(particle_t* parts, int num_parts, double size, int rank, int num_procs) {
    ...
    cout << "DEBUG rank: " << rank << " place: " << 1 << endl;            
    ...
    cout << "DEBUG rank: " << rank << " place: " << 2 << endl;            
    ...
    cout << "DEBUG rank: " << rank << " place: " << 3 << endl;            

    ////////////////////// RECV
    int upper_count=0, lower_count=0;
    // Clean upper and lower var
    // upper_row.clear();
    // lower_row.clear();
    ...
    cout << "DEBUG rank: " << rank << " place: " << 4 << endl;            
    ...
    cout << "DEBUG rank: " << rank << " place: " << 5 << endl;            

    cout << "DEBUG rank: " << rank << "lower: " << lower_count 
                                   << " upper: " << upper_count << endl; 
    // put upper row and lower row into bins
    for(int i=0;i<upper_count;i++){
        particle_t &p = upper_row[i];
        int bin_id = get_bin_id(p);
        // if(rank == 1) cout << "rank1 recv upper: (" << p.x << ',' << p.y << ") ";
        bins[bin_id].push_back(&p);
    }
    for(int i=0;i<lower_count;i++){
        particle_t &p = lower_row[i];
        int bin_id = get_bin_id(p);
        // if(rank == 1) cout << "rank1 recv lower: (" << p.x << ',' << p.y << ") ";
        bins[bin_id].push_back(&p);
    }

    cout << "DEBUG rank: " << rank << " place: " << 6 << endl;            
    ...
    cout << "DEBUG rank: " << rank << " place: " << 7 << endl;            
    ...
    cout << "DEBUG rank: " << rank << " place: " << 8 << endl;            
    ...
    cout << "DEBUG rank: " << rank << " place: " << 9 << endl;  
